...
const OfficerProfile = () => {
    ...
    const [formData, setFormData] = useState({
        name: user?.name || 'Officer Smith',
        email: user?.email || 'officer@civic.id',
        department: 'Census Division - Zone 4',
        employeeId: 'OFF-2024-1234',
        currentPassword: '',
        newPassword: '',
        confirmPassword: ''
    });
            ...
            <Card title="Profile Information">
                <form onSubmit={handleProfileUpdate} className="space-y-4">
                    <div className="flex items-center gap-4 mb-6">
                        <div className="h-20 w-20 rounded-full bg-yellow-100 flex items-center justify-center text-yellow-700 text-2xl font-bold">
